...
public class SpeakAndSpell {
	...
	public static void main(String[] args) {
		...
		String word = JOptionPane.showInputDialog("Try to spell that do your best");
		if (word.equals("conscience")) {
			speak("correct");
		} else {
			speak("wrong");
		}
		...
		// 2. Catch the user's answer in a String
		String words = JOptionPane.showInputDialog("Try to spell that do your best");
		if (words.equals("melancholy")) {
			speak("correct");
		} else {
			speak("wrong");
		}
		...
		String words1 = JOptionPane.showInputDialog("Try to spell that do your best");
		if (words1.equals("supercalifragilisticexpialidocious")) {
			speak("correct");
		} else {
			speak("wrong");
		}
